    ...
    <footer className="footer" role="contentinfo">
      <div className="footer__main container">
        ...
        <div className="footer__brand">
          <Link to="/" className="footer__logo" aria-label="Lumière Jewels">
            <span className="footer__logo-icon">✦</span>
            <span className="footer__logo-text">Lumière<em>Jewels</em></span>
          </Link>
          <p className="footer__tagline">
            Ethically crafted jewellery for life's most precious moments.
            Handmade in India, loved worldwide.
          </p>
          <div className="footer__social" aria-label="Social media links">
            ...
            <a href="#pinterest" className="footer__social-link" aria-label="Pinterest">
        ...
        <div className="footer__col">
          ...
          <address className="footer__address">
            ...
            <p>✉️ <a href="mailto:hello@lumierejewels.in">hello@lumierejewels.in</a></p>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <p className="footer__copy">© {year} Lumière Jewels. All rights reserved.</p>
